        ...
        try
        {
            ...
            if (Input.GetKeyDown(KeyCode.F2) && GameStates.IsInGame && Options.CurrentGameMode == CustomGameMode.Standard)
            {
                try
                {
                    ...
                    HudManager.Instance.ShowPopUp(addDes[addonInfoIndex] + "<size=0%>NEZZ</size>");
                }
                catch (Exception ex)
                {
                    Utils.ThrowException(ex);
            ...
            if (Input.GetKeyDown(KeyCode.F4) && GameStates.IsInGame && Options.CurrentGameMode == CustomGameMode.Standard)
            {
                try
                {
                    ...
                    HudManager.Instance.ShowPopUp(addSett[addonSettingsIndex] + "<size=0%>NEZZ</size>");
                }
                catch (Exception ex)
                {
                    Utils.ThrowException(ex);
            ...
            // Reset all NEZZ Settings to Default
